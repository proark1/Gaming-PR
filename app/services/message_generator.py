...
# ─── Base Message Generation (for bulk/all-outlets flow) ───
...
def generate_base_message(
    ...
    """
    Generate a generic English outreach message not tied to any specific outlet.
    Used as the base for translating into all outlet languages.
