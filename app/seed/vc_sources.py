...
GAMING_VC_SOURCES = [
    ...
    {"name": "Play Ventures", "url": "https://www.playventures.vc", "rss_feed_url": None, "language": "en", "region": "EU", "country": "Finland", "scraper_type": "vc", "priority": 1, "category": "gaming_vc", "description": "Gaming-focused venture capital firm", "social_twitter": "https://twitter.com/playaboratory", "scraper_config": {"blog_paths": ["/blog", "/news"], "portfolio_url": "/portfolio"}},
    ...
    {"name": "MTG (Modern Times Group)", "url": "https://www.mtg.com", "rss_feed_url": None, "language": "en", "region": "EU", "country": "Sweden", "scraper_type": "vc", "priority": 2, "category": "gaming_vc", "description": "Gaming and esports investment company", "social_twitter": "https://twitter.com/MTaborG", "scraper_config": {"blog_paths": ["/news", "/press-releases"], "portfolio_url": "/our-companies"}},
    {"name": "Krafton Ventures", "url": "https://www.krafton.com", "rss_feed_url": None, "language": "en", "region": "KR", "country": "South Korea", "scraper_type": "vc", "priority": 2, "category": "gaming_vc", "description": "PUBG creator's investment arm for gaming", "social_twitter": "https://twitter.com/ABORLC", "scraper_config": {"blog_paths": ["/blog", "/news", "/press"], "portfolio_url": "/investment"}},

    # Tier 3: Web3/Blockchain Gaming VCs
    {"name": "Animoca Brands", "url": "https://www.animocabrands.com", "rss_feed_url": None, "language": "en", "region": "HK", "country": "Hong Kong", "scraper_type": "vc", "priority": 2, "category": "gaming_vc", "description": "Web3 gaming investor and publisher", "social_twitter": "https://twitter.com/animaborandsAB", "scraper_config": {"blog_paths": ["/blog", "/news"], "portfolio_url": "/portfolio"}},
